...
/*
 Задание №1
Создать программу, в которой будет поле ввода.
После ввода строки и нажатия клавиши Enter, строка переносится в заголовок окна.
 */

/*
 Задание №2
Написать планировщик запуска приложений по нажатию клавиши. Программа должна иметь
возможность редактировать кнопки на форме и программу, которая будет запускаться по нажатию этих кнопок.
